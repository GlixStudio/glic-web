// GLIC Average Prediction Shader for TouchDesigner
// Implements average predictor (horizontal + vertical average)
...
void main() {
    ...
    // Average prediction: (left + top) / 2
    vec4 predicted;
    predicted.rgb = (left.rgb + top.rgb) * 0.5;
